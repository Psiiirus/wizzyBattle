...
private var NetworkUseNat : boolean = false;

public var serverConnectionCount : int = 2;
...
function MakeWindow (id : int) {
	...
	if (Network.peerType == NetworkPeerType.Disconnected)
	{
		...
		{
			Network.InitializeServer(serverConnectionCount, serverPort, true);
